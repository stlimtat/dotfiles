#!/bin/bash
# https://gist.githubusercontent.com/pwnsdx/1217727ca57de2dd2a372afdd7a0fc21/raw/00de789fef99e0238be96ee772d518b971d99379/disable.sh
...
mkdir mnt
# mount -o nobrowse -t apfs /dev/disk2s5 mnt/
mount -uw /Volumes/tanjiro
vim /Volumes/tanjiro/System/Library/Frameworks/NetworkExtension.framework/Versions/A/Resources/Info.plist
for agent in "${TODISABLE[@]}"
do
    mv /Volumes/tanjiro/System/Library/LaunchAgents/${agent}.plist /Volumes/tanjiro/System/Library/LaunchAgents/${agent}.plist.bak
...
do
    mv /Volumes/tanjiro/System/Library/LaunchDaemons/${daemon}.plist /Volumes/tanjiro/System/Library/LaunchDaemons/${daemon}.plist.bak
    echo "[OK] Daemon ${daemon} disabled"
done
bless --folder /Volumes/tanjiro/System/Library/CoreServices --bootefi --create-snapshot
